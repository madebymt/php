		...
		<div class="wrapper">
			...
			<div class="sandbox">
				...
				<p>This moustache is quite the dirt squirrel! It boasts a creep factor of <strong>
					<?php echo $moustaches[0]["creep_factor"];?>
				</strong> and takes <strong>
					<?php echo $moustaches[0]["avg_grow_day"];?> days
				</strong> to grow on average.</strong></p>

				<h2>The <?php echo $moustaches[1]["name"];?> Moustache!</h2>
				<p>This moustache is quite the dirt squirrel! It boasts a creep factor of <strong>
					<?php echo $moustaches[1]["creep_factor"];?>
				</strong> and takes <strong>
					<?php echo $moustaches[1]["avg_grow_day"];?> days
				</strong> to grow on average.</strong></p>

				<h2>The <?php echo $moustaches[2]["name"];?> Moustache!</h2>
				<p>This moustache is quite the dirt squirrel! It boasts a creep factor of <strong>
					<?php echo $moustaches[2]["creep_factor"];?>
				</strong> and takes <strong>
					<?php echo $moustaches[2]["avg_grow_day"];?> days
				</strong> to grow on average.</strong></p>
